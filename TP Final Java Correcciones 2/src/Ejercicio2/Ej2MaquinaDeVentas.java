...
public class Ej2MaquinaDeVentas extends javax.swing.JFrame {
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        verificarDineroSuficiente(precioDelProducto, dineroEntregado);        
    }//GEN-LAST:event_btnCargarActionPerformed

    public void verificarDineroSuficiente(int precioDelProducto, int dineroEntregado){
        
        if (dineroEntregado < precioDelProducto){
            VueltoCliente.etiquetaDineroInsuficiente.setVisible(true);
        }else if(dineroEntregado == precioDelProducto){
            VueltoCliente.etiquetaMontoExacto.setVisible(true);
        }else if(dineroEntregado > precioDelProducto){
            calcularVuelto(precioDelProducto, dineroEntregado);
        }        
    }    
    
    public void calcularVuelto(int precioDelProducto, int dineroEntregado) {
        int vuelto = dineroEntregado - precioDelProducto;
    ...
    public  int calcularDenominacion(int vuelto, int denominacion, String nombreDenominacion) {
        if (vuelto >= denominacion) {
            int cantidad = vuelto / denominacion;
            txtDineroEntregadoUsuario.setText(String.valueOf(cantidad));
